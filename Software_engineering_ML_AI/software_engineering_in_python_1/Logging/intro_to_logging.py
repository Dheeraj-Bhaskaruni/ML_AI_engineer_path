...
def convert(from_country, to_country, amount):
    ...
    if from_country != "USD":
        ...
        print(timestamp)
        print(__name__)
        print("INFO: Converting from {from_country} to USD: {converted_to_usd}".format(from_country=from_country,
        ...
        print(timestamp)
        print(__name__)
        print("INFO: Converting from USD to {to_country}: {converted_from_usd}".format(to_country=to_country,
